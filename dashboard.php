...
<body>
	...
	<nav class="navbar navbar-toggleable-sm navbar-inverse bg-inverse p-0">
		<div class="container">
			...
			<a href="#" class="navbar-brand mr-3">Uruwala Tea Factory</a>
	...
	<header id="main-header" class="bg-primary py-2 text-white">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<h1><i class="fa fa-tachometer"></i> Request</h1>
				</div>
			</div>
		</div>
	</header>
...
<?php 
	if (isset($_POST['apply'])){
		...
		$sql = "INSERT INTO leaves(name,email,leavedate,leavereason,status)VALUES('$name','$email','$leavedate','$editor1','$status')";
